...
def fetch_email_list_and_mail(leads_data):
    ...
    try:
        ...
        # Display user name for whom personalised email is being sent
            ...
            send_email('smtp.gmail.com',587, sender_details["sender_email"], 'Replace with password key', sender_details["sender_email"], lead["Email"],'Enhance Your Data Journey with FOSFOR - A Game-Changer from LTIMindtree',email_content)
            st.write("**************************************************************************")
    except Exception as e:
        print("An error occurred: ", str(e))
